...
final readonly class RegisterLendingRepaymentAction
{
    ...
    {
        throw_if($account->subtype !== LedgerAccountSubType::LOAN_RECEIVABLE, LedgerIntegrityException::class, 'Target account must be of type LOAN_RECEIVABLE.');
    }
